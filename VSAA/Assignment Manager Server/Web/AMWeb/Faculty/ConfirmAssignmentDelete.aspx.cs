...
{
	/// <summary>
	/// Summary description for ConfirmAssignmentDelete.
	/// </summary>
	public class ConfirmAssignmentDelete : System.Web.UI.Page
	{
		...
		public ConfirmAssignmentDelete()
		{
		...
		{
			this.lblConfirmDelete.Text = SharedSupport.GetLocalizedString("ConfirmAssignmentDelete_lblConfirmDelete");
		}
