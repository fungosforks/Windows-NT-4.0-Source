...
{
	/// <summary>
	/// Summary description for ConfirmResourceDelete.
	/// </summary>
	public class ConfirmResourceDelete : System.Web.UI.Page
	{
		...
		{
			this.lblConfirmDelete.Text = SharedSupport.GetLocalizedString("ConfirmResourceDelete_lblConfirmDelete");
		}
