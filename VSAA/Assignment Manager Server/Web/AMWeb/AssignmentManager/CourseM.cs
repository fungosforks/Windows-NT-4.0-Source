...
namespace Microsoft.VisualStudio.Academic.AssignmentManager
{
	...
	public class CourseM
	{
		...
		public AssignmentList AssignmentList
		{
			get
			{
				return AssignmentList.GetAssignmentListForCourse(_courseID);
			}
		}

		public AssignmentList GetStudentAssignmentList(int userID)
		{
			return AssignmentList.GetStudentAssignmentListForCourse(userID, _courseID);
		}
