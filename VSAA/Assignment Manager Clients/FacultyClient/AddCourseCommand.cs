...
namespace FacultyClient
{
	...
	public class AddCourseCommand : IAddInCommand
	{
		...
		public void OnConnection(EnvDTE._DTE application, Extensibility.ext_ConnectMode connectMode, EnvDTE.AddIn addIn)
		{
			...
			m_strCommandName = "AMAddCourse";
			m_strName = AMResources.GetLocalizedString("AMAddCourseName");
			m_strItemText= AMResources.GetLocalizedString("AMAddCourseItemText");

			string description = AMResources.GetLocalizedString("AMAddCourseDescription");
